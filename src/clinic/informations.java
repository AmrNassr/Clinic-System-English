...
headerLabel1d.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jPanel14.add(delete4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 180, 50));

        jLabel15.setBackground(new java.awt.Color(255, 255, 255));
        jLabel15.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel15.setText("Does Name");
        jPanel14.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 140, 30));

        lname1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel14.add(lname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 100, 230, 30));
        ...
        jPanel14.add(save4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 180, 40));
        ...
        jTabbedPane1.addTab("The Does", jPanel14);
        ...
        jPanel10.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 120, 90, -1));
        ...
        jPanel10.add(cmpatient1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 230, 30));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 180, 50));

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel13.setText("Medicines Name");
        jPanel10.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 160, -1));

        name.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 50, 230, 30));
        ...
        jPanel10.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 180, 40));
        ...
        jTabbedPane1.addTab("Medicines Name", jPanel10);
        ...
        jPanel12.add(price, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 70, 30));

        jLabel20.setBackground(new java.awt.Color(255, 255, 255));
        jLabel20.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel20.setText("Operation Price");
        jPanel12.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 160, -1));
        ...
        jPanel12.add(delete2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 180, 50));

        jLabel19.setBackground(new java.awt.Color(255, 255, 255));
        jLabel19.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel19.setText("Operation Name");
        jPanel12.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 160, -1));

        oname.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel12.add(oname, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 230, 30));
        ...
        jPanel12.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 130, 180, 40));
        ...
        jTabbedPane1.addTab("Operations Name", jPanel12);
        ...
        jPanel11.add(delete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 180, 50));

        jLabel14.setBackground(new java.awt.Color(255, 255, 255));
        jLabel14.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel14.setText("Laboratory analyze  Name");
        jPanel11.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 250, -1));

        lname.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel11.add(lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 100, 230, 30));
        ...
        jPanel11.add(save2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 180, 40));
        ...
        jTabbedPane1.addTab("Laboratory analyzes ", jPanel11);
        ...
        jPanel13.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 50, 230, 30));

        jLabel23.setBackground(new java.awt.Color(255, 255, 255));
        jLabel23.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel23.setText("Password");
        jPanel13.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 120, 30));

        jLabel24.setBackground(new java.awt.Color(255, 255, 255));
        jLabel24.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel24.setText("User Name");
        jPanel13.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 112, 160, 30));

        user.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel13.add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 240, 30));

        pass.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel13.add(pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 110, 230, 30));

        jLabel21.setBackground(new java.awt.Color(255, 255, 255));
        jLabel21.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel21.setText("specialties");
        jPanel13.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 50, 160, -1));
        ...
        jPanel13.add(delete3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 510, 180, 50));

        jLabel22.setBackground(new java.awt.Color(255, 255, 255));
        jLabel22.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel22.setText("Doctor Name");
        jPanel13.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 50, 160, 30));

        dname.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel13.add(dname, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, 230, 30));
        ...
        jPanel13.add(save3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 180, 40));
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName("Operations Name");
         ...
         if(serialid.getText().trim().isEmpty())
        {
            ...
            if(dialogResult == 0) {
                try {
                    ...
                    pst.execute();
                    JOptionPane.showMessageDialog(rootPane, " Medicines Deleted successfully");
                    tablelorddruglist();
                    clear();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        try
        {
            ...
            if(serialid.getText().trim().isEmpty())
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, " Please enter Drug Name ");
                }
                else
                {
                    int dialogButton = JOptionPane.YES_NO_OPTION;
    ...
    private void delete2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete2ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(rootPane, "Please select operation");
            ...
            if(dialogResult == 0) {
                try {
                    ...
                    pst=(PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
                    JOptionPane.showMessageDialog(rootPane, " operation Deleted successfully");
                    clear();
                            tablelordoperationlist();
                            oname.requestFocus();
                } catch (SQLException ex) {
 ...
 try
        {
            ...
            if(serialid2.getText().trim().isEmpty())
            {
               if( oname.getText().trim().isEmpty() )
                {
                    JOptionPane.showMessageDialog(this, " Please enter Operation Name ");
                }
                else
                {
                    int dialogButton = JOptionPane.YES_NO_OPTION;
                    ...
                    if(dialogResult == 0) {
                        try{
                            ...
                            pst = (PreparedStatement)con.prepareStatement(sql);
                            pst.execute();
                            JOptionPane.showMessageDialog(null, "Operation Added successfully");
                             clear();
                            tablelordoperationlist();
                            oname.requestFocus();
                            ...
                            JOptionPane.showMessageDialog(null,"Operation already Exists");
                        }
            ...
            else
            {
                 ...
                 String sqla = "UPDATE clinic.operationslist SET name='"+namee+"',price='"+pricee+"' where id = '"+serialid2.getText()+"'";
                  pst=(PreparedStatement) con.prepareStatement(sqla);
                  pst.executeUpdate();
                  JOptionPane.showMessageDialog(this, "Operation updated Successfully");
                  clear();
                            tablelordoperationlist();
                            oname.requestFocus();
            }
        ...
        if(serialid1.getText().trim().isEmpty())
        {
            ...
            if(dialogResult == 0) {
                try {
                    ...
                    pst=(PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
                    JOptionPane.showMessageDialog(rootPane, " analyze Deleted successfully");
                    tablelordanalyzeslistlist();
                    clear();
                } catch (SQLException ex) {
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        try
        {
            ...
            if(serialid1.getText().trim().isEmpty())
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, " Please enter analyze Name ");
                }
                else
                {
                    int dialogButton = JOptionPane.YES_NO_OPTION;
                    ...
                    if(dialogResult == 0) {
                        try{
                            ...
                            pst = (PreparedStatement)con.prepareStatement(sql);
                            pst.execute();
                            JOptionPane.showMessageDialog(null, "analyze Added successfully");
                             clear();
                            tablelordanalyzeslistlist();

                        }
                        catch(Exception e ){
                            JOptionPane.showMessageDialog(null,"analyze already Exists");
                        }
            ...
            else
            {
                 String sqla = "UPDATE clinic.analyzeslist SET name='"+namee+"' where id = '"+serialid1.getText()+"'";
                  pst=(PreparedStatement) con.prepareStatement(sqla);
                  pst.executeUpdate();
                  JOptionPane.showMessageDialog(this, "analyze updated Successfully");
                  tablelordanalyzeslistlist();
                  clear();
                  lname.requestFocus();
            }
    ...
    private void save3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save3ActionPerformed
        try
        {
            ...
            if(serialid3.getText().trim().isEmpty())
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, " Please enter Doctor Name And Type ");
                }
                else
                {
    ...
    private void delete4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete4ActionPerformed
       if(serialid4.getText().trim().isEmpty())
        {
            JOptionPane.showMessageDialog(rootPane, "Please select dose");
            ...
            if(dialogResult == 0) {
                try {
                    ...
                    pst=(PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
                    JOptionPane.showMessageDialog(rootPane, " dose Deleted successfully");
                    tablelorddose();
                    clear();
                } catch (SQLException ex) {
    ...
    private void save4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save4ActionPerformed
                try
        {
            ...
            if(serialid4.getText().trim().isEmpty())
            {
                ...
                {
                    JOptionPane.showMessageDialog(this, " Please enter Dose Name ");
                }
                else
                {
                    int dialogButton = JOptionPane.YES_NO_OPTION;
                    ...
                    if(dialogResult == 0) {
                        try{
                            ...
                            JOptionPane.showMessageDialog(null,"Dose already Exists");
                        }
            ...
            else
            {
                 String sqla = "UPDATE clinic.dose SET name='"+namee+"' where id = '"+serialid4.getText()+"'";
                  pst=(PreparedStatement) con.prepareStatement(sqla);
                  pst.executeUpdate();
                  JOptionPane.showMessageDialog(this, "Dose updated Successfully");
                  tablelorddose();
                  clear();
                  lname1.requestFocus();
            }
