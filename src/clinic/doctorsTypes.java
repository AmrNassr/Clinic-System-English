...
Connection con ;
    ...
    private void initComponents() {
        ...
        jLabel17.setText("specialtie Name");
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 160, 30));

        name.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jPanel1.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 260, 40));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            {
                JOptionPane.showMessageDialog(this, " Please add specialtie");
            }
            else
            {
